...
def ps1_query_old(ra_deg, dec_deg, rad_deg, maxmag=20,
               maxsources=10000):
    """
...
def ps1_query(ra,dec,radius,table='mean',release='dr2',verbose=False):
    """
    ...
    results = ps1cone(ra,dec,radius,table=table,release=release,
                      columns=columns,verbose=verbose,**constraints)
