...
def SDSS2Johnson(band, SDSS_Table):
    ...
    if band in V_band:
        ...
        SDSS_Table["VMag"] = SDSS_Table["gmag"] + poly(SDSS_Table['g-r'],
                                                            coefficients)
        SDSS_Table["calib_err"] = np.sqrt((0.002/0.573)**2 + (0.002/0.016)**2 + (SDSS_Table['e_gmag']/SDSS_Table['gmag'])**2 + (SDSS_Table['e_rmag']/SDSS_Table['rmag'])**2) * SDSS_Table["VMag"]
    ...
    if band in R_band:
        ...
        SDSS_Table["RMag"] = SDSS_Table["rmag"] + poly(SDSS_Table['r-i'],
                                                            coefficients)
        SDSS_Table["calib_err"] = np.sqrt((0.004/0.257)**2 + (0.002/0.152)**2 + (SDSS_Table['e_rmag']/SDSS_Table['rmag'])**2 + (SDSS_Table['e_imag']/SDSS_Table['imag'])**2) * SDSS_Table["RMag"]
    ...
    if band in I_band:
        ...
        SDSS_Table["IMag"] = SDSS_Table["imag"] + poly(SDSS_Table['i-z'],
                                                            coefficients)
        SDSS_Table["calib_err"] = np.sqrt((0.006/0.409)**2 + (0.002/0.394)**2 + (SDSS_Table['e_zmag']/SDSS_Table['zmag'])**2 + (SDSS_Table['e_imag']/SDSS_Table['imag'])**2) * SDSS_Table["IMag"]
    ...
    if band in B_band:
        ...
        SDSS_Table["BMag"] = SDSS_Table["gmag"] + poly(SDSS_Table['g-r'],
                                                            coefficients)
        SDSS_Table["calib_err"] = np.sqrt((0.002/0.219)**2 + (0.003/0.312)**2 + (SDSS_Table['e_gmag']/SDSS_Table['gmag'])**2 + (SDSS_Table['e_rmag']/SDSS_Table['rmag'])**2) * SDSS_Table["BMag"]
...
def PS2Johnson(band, PS_Table):
    ...
    if band in V_band:
        ...
        PS_Table["VMag"] = PS_Table["gmag"] + poly(PS_Table['g-r'],
                                                            coefficients)
        PS_Table["calib_err"] = np.sqrt((0.002/0.573)**2 + (0.002/0.016)**2 + (PS_Table['e_gmag']/PS_Table['gmag'])**2 + (PS_Table['e_rmag']/PS_Table['rmag'])**2) * PS_Table["VMag"]
    ...
    if band in R_band:
        ...
        PS_Table["RMag"] = PS_Table["rmag"] + poly(PS_Table['r-i'],
                                                            coefficients)
        PS_Table["calib_err"] = np.sqrt((0.004/0.257)**2 + (0.002/0.152)**2 + (PS_Table['e_rmag']/PS_Table['rmag'])**2 + (PS_Table['e_imag']/PS_Table['imag'])**2) * PS_Table["RMag"]
    ...
    if band in I_band:
        ...
        PS_Table["IMag"] = PS_Table["imag"] + poly(PS_Table['i-z'],
                                                            coefficients)
        PS_Table["calib_err"] = np.sqrt((0.006/0.409)**2 + (0.002/0.394)**2 + (PS_Table['e_zmag']/PS_Table['zmag'])**2 + (PS_Table['e_imag']/PS_Table['imag'])**2) * PS_Table["IMag"]
    ...
    if band in B_band:
        ...
        PS_Table["BMag"] = PS_Table["gmag"] + poly(PS_Table['g-r'],
                                                            coefficients)
        PS_Table["calib_err"] = np.sqrt((0.002/0.219)**2 + (0.003/0.312)**2 + (PS_Table['e_gmag']/PS_Table['gmag'])**2 + (PS_Table['e_rmag']/PS_Table['rmag'])**2) * PS_Table["VMag"]
