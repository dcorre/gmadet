...
def sanitise_headers(filename):
    ...
    keywords_to_keep = ["SIMPLE", "BITPIX", "NAXIS", "NAXIS1", "NAXIS2",
                        "EXTEND", "DATE-OBS", "TELESCOP", "INSTRUME",
                        "OBJECT", "EXPTIME", "FILTER", "GAIN",
                        "SATURATE", "EQUINOX", "EPOCH", "RADESYS", "CTYPE1",
                        "CTYPE2", "CUNIT1", "CUNIT2", "CRVAL1", "CRVAL2",
                        "CRPIX1", "CRPIX2", "CD1_1", "CD1_2", "CD2_1",
                        "CD2_2", "CDELT1", "CDELT2", "CROTA1", "CROTA2",
                        "BSCALE", "BZERO", "BUNIT", "AIRMASS", "END"]
